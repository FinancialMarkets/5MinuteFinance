...
-  A part of a new broad open-source initiative at MI: https://github.com/FinancialMarkets  
...
These apps will also allow you to look at financial concepts in way they haven't been seen before.  This is often done by leveraging javascript libraries (htmlwidgets).
...
-  You can move the surface around to get a better look at the relationships---for example take a look at how duration is affected by time to maturity.
...
Financial markets generate massive amounts of data every day.  These apps will give you access to the data, 
