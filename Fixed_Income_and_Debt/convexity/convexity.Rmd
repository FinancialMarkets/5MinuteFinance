...
Bond convexity refers to the actual convex (non-linear) relationship between a bond's price and yield.  This is stated in relation to the linear [duration](https://micfm.shinyapps.io/intro_duration/) approximation of the bond price and yield relationship.
