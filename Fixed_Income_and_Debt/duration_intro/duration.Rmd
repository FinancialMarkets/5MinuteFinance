...
With the following app, you can set the maximum yield-to-maturity and time to maturity and see the 3D duration surface.  You can also change the coupon rate and see the effect on the duration surface.

-  You can move the 3D surface around, and zoom in and out, with your mouse.

-  Note duration is highest for low yield-to-maturity and long time to maturity bond's.
...
-  This is covered in the slides on "Bond Convexity".
