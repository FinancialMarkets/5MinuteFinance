...
Duration can be thought of as the weighted-average of when the bondholder received payment.  The weights are the proportion of the bond's total value received in each period. 
