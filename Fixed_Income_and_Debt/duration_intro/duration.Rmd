...
-  This is covered in the Milken Institute CFM interactive presentation on [Bond Convexity](https://micfm.shinyapps.io/convexity/).

<div class="MIfooter"><img src="mi.png" style="height:50px;"></div> 

## Credits and Collaboration

If you have additions or corrections for this presentation, feel free to contribute them [to this GitHub repo](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Fixed_Income_and_Debt/duration_intro/duration.Rmd).  You will automatically show up as a presentation author.  
