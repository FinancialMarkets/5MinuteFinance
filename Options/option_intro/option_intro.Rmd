...
>+ Arbitrage: If the intrinsic were \$5, and the options price was \$3, you could buy the call option and immediately exercise it earning a riskless \$2/share.  
    ...
    mainPanel(
	  ...
	  intrinsic.p[intrinsic.p < 0] <- 0
            ...
            intrinsicPut.p[intrinsicPut.p < 0] <- 0
                ...
                legend('topright', c("Intrinsic Value", "Option Value", "Time Value"), lty = c(1,1,1), col=c(1,"dodgerblue4", "lightblue"), lwd = c(4,4, 15))
                ##  shade region  ----
...
-  Use the app to see how the underlying variables affect the option price.  For example, how does an increase in interest rates effect call and put values?  How about an increase in volatility?
...
If you have additions or corrections for this presentation, feel free to contribute them [to this GitHub repo](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Options/option_intro/option_intro.Rmd).  You will automatically show up as a presentation author.  
