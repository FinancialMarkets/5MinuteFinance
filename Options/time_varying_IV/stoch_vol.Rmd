...
Implied volatility is the market's expectation of a security's volatility extracted from option prices on that security.  It is the volatility expected over the life of that option.  We calculate Implied Volatility using the Black-Scholes option pricing model---solving the equation for volatility and plug in the option price we observe in the market.  
