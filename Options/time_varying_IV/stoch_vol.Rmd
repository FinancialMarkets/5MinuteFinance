...
The option smile is known to take different shapes depending on the options expiration.  The general form of the smile is the same, however the sensitivity of implied volatility to moneyness amy be different fir varying expirations.  
