...
*Important Note:* Volatility is assumed to be constant in the Black-Scholes model.  This is widely known to be an poor assumption, which has a material impact on the option value.  
...
<!--- two apps: 1. calculating historical vol & 2. implied vol -->
