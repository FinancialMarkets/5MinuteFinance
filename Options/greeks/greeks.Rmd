...
Broadly, the Greeks measure the sensitivity of an option's premium to changes in the underlying variables.
...
-  This means the underlying variables are the: stock price; volatility; risk-free rate; time.

-  Note, each Greek (being a partial derivative of the Black-Scholes equation) assumes all other variables remain constant.
...
##  Greek: Underlying Variable

Delta ($\Delta$):  Stock price.

Gamma ($\Gamma$):  Stock price.

Theta ($\Theta$):  Time

Rho ($\rho$): Risk-free rate

Vega ($v$) (Not Greek): Volatility
...
sidebarLayout(
    sidebarPanel(
        ...
        conditionalPanel(
            ...
            sliderInput("strike", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis == '2'",
            sliderInput("stock1", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol1", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf1", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time1", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis == '3'",
            sliderInput("stock2", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike2", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("rf2", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time2", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis == '4'",
            sliderInput("stock3", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike3", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol3", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("time3", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis == '5'",
            sliderInput("strike4", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol4", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf4", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("stock4", "Stock Price", min=1, max=100, value=50, step = 1)
            )
        ),
...
To create a Gamma neutral portfolio, you'll have to trade in an option on the underlying---or some derivative which is not linearly related to the underlying.
...
-  Use the following app to find the situation for which theta is positive?
...
sidebarLayout(
    sidebarPanel(
        ...
        conditionalPanel(
            ...
            sliderInput("strike10", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol10", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf10", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time10", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis2 == '2'",
            sliderInput("stock11", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol11", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf11", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time11", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis2 == '3'",
            sliderInput("stock12", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike12", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("rf12", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time12", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis2 == '4'",
            sliderInput("stock13", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike13", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol13", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("time13", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis2 == '5'",
            sliderInput("strike14", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol14", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf14", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("stock14", "Stock Price", min=1, max=100, value=50, step = 1)
            )
        ),
...
sidebarLayout(
    sidebarPanel(
        ...
        conditionalPanel(
            ...
            sliderInput("strike15", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol15", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf15", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time15", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis3 == '2'",
            sliderInput("stock16", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol16", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf16", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time16", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis3 == '3'",
            sliderInput("stock17", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike17", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("rf17", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time17", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis3 == '4'",
            sliderInput("stock18", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike18", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol18", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("time18", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis3 == '5'",
            sliderInput("strike19", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol19", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf19", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("stock19", "Stock Price", min=1, max=100, value=50, step = 1)
            )
        ),
...
sidebarLayout(
    sidebarPanel(
        ...
        conditionalPanel(
            ...
            sliderInput("strike20", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol20", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf20", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time20", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis4 == '2'",
            sliderInput("stock21", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol21", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf21", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time21", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis4 == '3'",
            sliderInput("stock22", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike22", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("rf22", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("time22", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis4 == '4'",
            sliderInput("stock23", "Stock Price", min=1, max=100, value=50, step = 1),
            sliderInput("strike23", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol23", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("time23", "Time", min=0.01, max=2, value=0.5, step = 0.1)
            ),

        conditionalPanel(
            condition = "input.xaxis4 == '5'",
            sliderInput("strike24", "Strike Price", min=1, max=100, value=50, step = 1),
            sliderInput("vol24", "Volatility", min=0.01, max=1, value=0.20, step = 0.01),
            sliderInput("rf24", "Risk-Free", min=0.01, max=0.2, value=0.02, step = 0.01),
            sliderInput("stock24", "Stock Price", min=1, max=100, value=50, step = 1)
            )
        ),
...
[possibly links to related presentations]
