...
-  Note, here we assume either the investor ignores portfolio [skewness](https://en.wikipedia.org/wiki/Skewness) and [kurtosis](https://en.wikipedia.org/wiki/Kurtosis), or returns are distributed according to an elliptical distribution (such as the normal distribution).  
