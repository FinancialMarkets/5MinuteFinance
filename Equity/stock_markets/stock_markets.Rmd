...
The secondary market is the one you see every day in the news, and the one we'll cover in this presentation.
...
-  Facilitating this is the central reporting of trades and quotes through the [consolidated tape system](http://www.sec.gov/answers/consolt.htm) implemented in 1976.
...
-  Moving to purely electronic communication has also greatly increased the speed with which market participants can trade.  In fact, there are now those who specialize in speed---known as *High Frequency Traders*. 
...
- In the next app, we'll show a different view of the US stock market.  Exchanges are grouped by how similar their quotes will be to other exchanges (based on distance to the other exchange).  
