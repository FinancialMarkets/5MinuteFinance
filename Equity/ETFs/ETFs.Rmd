...
-  ETFs can be traded throughout the day, and may be [shorted](https://micfm.shinyapps.io/short_selling_stock/) and bought on margin.  The cost of buying an ETF is the same as stock.
...
Click and drag on graph to zoom into selected time period. Double click to return to full view
...
Click [here](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Equity/ETFs/ETFs.Rmd) to see the code and collaborators for this presentation
