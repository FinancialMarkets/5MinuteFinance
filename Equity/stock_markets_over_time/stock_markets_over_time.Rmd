...
Click [here](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Equity/stock_markets_over_time/stock_markets_over_time.Rmd) to see the code and collaborators for this presentation
