...
- We then calculate the average squared difference between the prices, and the standard deviation of the squared difference in the prices.  These two statistics (mean and standard deviation) allow us to categorize normal, and abnormal, behavior for a pair.  
...
-  When the squared deviation deviated from its average by a threshold number of standard deviations, we'll initiate a pairs trade. 
