...
- We first calculate normalized prices (cumulative returns) over some past period, so each stock price is on the same scale.
...
shinyUI(fluidPage(
    ...
    fluidRow(
        column(3, wellPanel(
                      ...
                      dateInput("estim_period_start", "Estimation Period Start", value = "2015-09-01"), 
                      dateInput("estim_period_end", "End", value = "2015-12-31"), 
