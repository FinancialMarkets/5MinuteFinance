...
If the two stocks are really good substitutes for one another, they likely have similar levels of market risk (measured by [beta coefficients](http://www.5minutefinance.org/concepts/the-greeks)). You can therefore buy and short equal dollar amounts. 
