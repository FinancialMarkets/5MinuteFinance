...
There is no single way to implement the pairs trade. This is an active area of research, and provides you with a venue to create your own strategy.  Following are the general steps of the pairs trade, and your method in any step can be different from methods employed by others.
