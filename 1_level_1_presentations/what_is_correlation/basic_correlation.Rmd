...
-  Changing the 'Multiple' slider will multiply the 'z' variable by that number.  You'll see it doesn't change the correlation coefficient -- only the scale of the 'z' axis.  Linear transformations do not affect correlation.

-  Then choose the radio butting to square z.  You'll see this transformation will change the correlation.  Nonlinear transformations so affect correlation. 
