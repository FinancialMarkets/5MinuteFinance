...
-  Say the price of security *A* is greater than *B*, and they have the same payoff. You could sell *A* and buy *B*, earning \$*A−B*, but the payoffs (being the same) will net to \$0.
...
```{r warning = FALSE, messsage = FALSE, echo = FALSE, error = FALSE}
#{{{
...
Click the following links to see the [code](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Equity/pairs_trade/pairs_trade.Rmd), [line-by-line contributions to this presentation](https://github.com/FinancialMarkets/5MinuteFinance/blame/master/Equity/pairs_trade/pairs_trade.Rmd), and [all the collaborators who have contributed to 5-Minute Finance via GitHub](https://github.com/FinancialMarkets/5MinuteFinance/graphs/contributors).
