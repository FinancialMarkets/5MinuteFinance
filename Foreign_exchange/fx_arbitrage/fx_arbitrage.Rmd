...
In this presentation we'll cover three arbitrages which are common in FX markets.  These are:
...
Now consider East quotes USD 1.50/1.55 for GBP, and West quotes USD 1.56/1.58.  The notation refers to the bid/ask.  Is there an arbitrage?

-  Yes, buy 1 GBP from East for USD 1.55, and sell it to west for USD 1.56, earning USD 0.01 per GBP traded.

What about if East quotes USD 1.50/1.55 for GBP, and West quotes USD 1.54/1.58?  Is there an arbitrage?

-  No.  Buying a GBP at East for USD 1.55 and selling at West for USD 1.54 would lose you USD 0.01.
...
-  A currency cross-rate is an exchange rate which does not involve the USD.
...
-  Or simple note that it must be more than 1 CHF for a GBP, and not vice versa.

<div class="MIfooter"><img src="mi.png" style="height:50px;"></div> 

## Triangular Arbitrage

Triangular arbitrage takes advantage of mispriced cross-rates.  Say, you open your terminal and see the following quotes.
...
[graphic:  triangle with USD, GBP, and CHF]
...
If you don't sell the currency forward, then you are engaging in uncovered interest arbitrage.

-  This is a particularly bad title, because it is *not* an arbitrage.

-  A better title, that is often used, is the 'Carry Trade'.  
