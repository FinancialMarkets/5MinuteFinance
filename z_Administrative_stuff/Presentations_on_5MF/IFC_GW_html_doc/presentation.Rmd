---
title: "[5MinuteFinance](http://www.5minutefinance.org/)"
...
Milken Institute Center for Financial Markets (MICFM) initiative to create innovative and interactive educational materials on financial topics.  

The website is here: [http://www.5minutefinance.org/](http://www.5minutefinance.org/).  The website will be live in September 2016.  

-  The project receives contributions from the wider finance community.  The code is hosted here: [github.com/FinancialMarkets/5MinuteFinance](https://github.com/FinancialMarkets/5MinuteFinance)
...
These presentations take the static financial topics you may see in a textbook, and brings them off the page and allows you to interact with them.  This allows you to learn in a hands-on fashion.  

-  For example, take a look at the interactive app on the next slide.

-  The app shows the duration approximation of a bond's sensitivity to changes in interest rates.  However it also allows you to change the underlying factors which affect duration, and see how duration reacts.  

- You can also see when the convexity causes large errors.  
...
However, these apps will also allow you to look at financial concepts in way they haven't been seen before.  This is often done by leveraging javascript libraries (htmlwidgets).

-  You can interact with these visualizations with the mouse. 

-  For example, the next slide shows the duration surface as a function of coupon rate, and time and yield to maturity.

-  You can move the surface around to get a better look at the relationships---take a look at how duration is affected by time to maturity.
...
Financial markets generate massive amounts of data every day.  You can't really understand what is going on in markets, without seeing them in action.  Moreover, theory is ultimately tested with data.

-  However handling data can be difficult as data are often stored and delivered in different formats, for example .csv, JSON, XML.  Further, very large data sets take particular tools to handle.  

-  These apps will give you access to the data, and allow you to see what is happening in financial markets, without having to spend time gathering and cleaning the data.  

-  You are free to spend your time learning the concepts.  
...
<!-- insert risk over time app here -->
## 
...
##  What Types of Calculations Can We Do?

Anything.  Powering these calculations is the [R programming language](https://www.r-project.org/) which is a full blown statistical computing environment.  Further, we can call C++ code from R thanks to packages such as [Rcpp](www.rcpp.org). 

-  In short, any calculation you would like to see, we can do.

-  Take a look at the [CRAN Task Views](https://cran.r-project.org/web/views/) for prepackaged capabilities of R.  

-  For example, the next app will calculate option *Greeks*. 
...
We are fostering a community effort to create a set of finance education and course materials. Collaboration and attribution are managed through GitHub.
...
-  Material users are encouraged to contribute back to the code.
...
Financial Education Advisor, Milken Institute Center for Financial Markets

[github.com/Matt-Brigida](https://github.com/Matt-Brigida)

email: mbrigida@milkeninstitute.org
