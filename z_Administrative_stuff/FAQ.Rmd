...
A:  [This video](https://www.youtube.com/watch?v=4zDQSibnyzM) describes how to issue a pull request using RStudio.  RStudio is a popular development environment for R.  If you are new to R, we recommend using RStudio.  [This video](https://www.youtube.com/watch?v=pII-Jop07yM) describes how to issue a pull request using the command line in Linux/Mac.
...
A:  No, you can edit files in the browser, [as explained here](https://www.youtube.com/watch?v=iVC9UKkaiko).  However, you are not able to see how your changes will affect the presentation, so you will have a hard time editing the R code sections.  You are probably limited to editing the text, which is nonetheless very useful!
