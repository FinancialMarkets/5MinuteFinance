...
Milken Institute Center for Financial Markets initiative to create short, informative, educational materials on financial topics.  The project welcomes contributions from the wider finance community.  

-  All materials and source code are released under open-source (GPL) and creative commons licenses.
-  A part of a broader open-sourse initiative at MI: https://github.com/FinancialMarkets
