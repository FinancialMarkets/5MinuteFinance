...
-  The following app will plot the absolute value of the return (Realized Volatility) for any stock and date range you choose.  Can you see volatility cluster -- try long time periods.  
