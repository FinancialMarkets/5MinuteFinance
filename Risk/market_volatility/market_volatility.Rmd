...
inputPanel(
    selectizeInput("name1", label = "Type a Stock's Name", multiple = FALSE, choices = comp$name),
    dateRangeInput("date1", "Date Range", start = "2015-01-01", end = Sys.Date())
    ## add date range input 
)
...
## code modified from here:  https://github.com/ramnathv/rChartsCalmap
    ...
    # )
    # 
    # ticker <- comp$symbol[comp$name == input$name1]
    # 
