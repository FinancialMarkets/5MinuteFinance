...
-  The CAPM builds on (Markowitz portfolio optimization)[https://micfm.shinyapps.io/markowitz], by assuming all investors will hold the market portfolio.  
...
renderPlot({
  ...
  x <- seq(0, 2 * pi, by = .01)
  plot(0.25 * sin(10 * x) + 0.1, type = 'l', lwd = 2, col = 3, ylab = "Asset Return", ylim = c(-.2, .4), xlab = "", xaxt = 'n', yaxt = 'n')
