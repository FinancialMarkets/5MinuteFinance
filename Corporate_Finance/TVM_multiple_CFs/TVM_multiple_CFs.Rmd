...
An **annuity** is a contract which pays a fixed amount at the end of each period for a fixed number of periods.  Many common financial contract are annuities, such as fixed rate mortgages and auto loans.  If the payments are in the beginning of a period (such as renting an apartment) the contract is known as an *annuity due*.
