...
In the following interactive app you can chart the dividend for any stock.  

-  To see the dividend for the `SPY` (the S&P 500 SPDR) start typing `sp` and it will be the first option.  
