...
Balanacing the benefit of the debt tax shield with the cost of financial distress, implies the existence of an optimal capital structure. That doesn't mean we have a formula---only that there is evidence that such a capital structure exists.   
...
## Static Trade-off Theory Graphic
