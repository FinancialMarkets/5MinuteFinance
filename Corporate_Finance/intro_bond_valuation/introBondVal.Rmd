...
- These calculations are equivalent, and the differences are only matters of notation.  When using in a spreadsheet, the calculations usually laid out in a form similar to the table.  The annuity formula was mainly taught because prior to spreadsheets people were doing these calculations by calculator.
