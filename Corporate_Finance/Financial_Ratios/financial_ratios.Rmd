...
## Example: The Debt-to-Equity and Equity Multiplier Ratios
...
The equity multiplier is a firm's assets divided by it equity.
- The balance sheet is a statement of a firm's assets, liabilities (debts), and equity. If we know two of the three we can infer the third, remember Assets - Equity = Liabilities

-  Equity Multiplier - 1 = Debt-to-Equity Ratio
-  $\frac{Assets}{Equity} - \frac{Equity}{Equity} = \frac{Debt}{Equity}$
-  
<div class="MIfooter"><img src="mi.png" style="height:50px;"></div> 
...
-  Where $Return on Equity = Profit Margin\: x\: Total-asset-turnover\: x\: Equity Multiplier $ 
