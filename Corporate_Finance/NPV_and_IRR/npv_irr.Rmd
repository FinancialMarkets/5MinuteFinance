...
## Mutually Exclusive \& Conventional CFs 

When the accept/reject decision on one project does not affect another (projects are *mutually exclusive*), and  the project has negative cash flows followed by all positive cash flows (*conventional CFs*), then NPV and IRR will lead to the same accept/reject decision, i.e. $NPV \iff IRR$

-  If you must rank projects (projects are *not* mutually exclusive) or cash flows are unconventional, then use *NPV*.  *NPV* will generate the correct decision, though *IRR* may not.
...
Click [here](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Corporate_Finance/NPV_and_IRR/npv_irr.Rmd) to see the code and collaborators for this presentation
