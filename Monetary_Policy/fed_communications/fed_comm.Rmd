...
#{{{
 ...
 inputPanel(
	    ...
	    selectizeInput("phrase", "FOMC Message",
                 ...
                 "Open market operations" = "When the Federal Reserve (or any central bank) buys or sells government securities in the open markets to influence market lending rates",
                 "Gradual adjustments in the stance of monetary policy" = "Slight changes over time to the federal funds rate",
                 "Substantial resource slack is likely to dampen cost pressures" = "The surplus of supply in oil and gas and other commodity markets is likely to keep energy prices from spiking",
                 "Sharp and protracted correction" = "An economic crisis or severe downturn following a period of high growth – or, more colloquially, the bust following a boom",
