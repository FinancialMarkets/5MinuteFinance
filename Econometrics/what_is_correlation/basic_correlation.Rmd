...
The above explains why, during a market crash, stock correlations approach 1 while many stocks have high (> 5) [betas](http://www.5minutefinance.org/concepts/the-capital-asset-pricing-model).
...
This also helps explain the optimal hedge ratio (see the [Cross Hedging](http://www.5minutefinance.org/concepts/cross-hedging) and [First Look at Risk](http://www.5minutefinance.org/concepts/intro-risk) presentations). Even if the assets are perfectly correlated, you will likely have a hedge ratio different from 1 given different volatilities.
...
Click the following links to see the [code](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Econometrics/what_is_correlation/basic_correlation.Rmd), [authors of this presentation](https://github.com/FinancialMarkets/5MinuteFinance/blame/master/Econometrics/what_is_correlation/basic_correlation.Rmd), and [all the collaborators who have contributed to 5MinuteFinance](https://github.com/FinancialMarkets/5MinuteFinance/graphs/contributors).
