...
-  Changing the 'Multiple' slider will multiply the 'x' variable by that number.  You'll see it doesn't change the correlation coefficient -- only the slope of the graph.
