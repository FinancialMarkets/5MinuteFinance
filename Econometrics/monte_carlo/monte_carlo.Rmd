...
-  Monte Carlo is a computational tool used to guage probabilities.  
...
When an analytic solution (that is, an analytical discovery of patterns in data) is available, you should generally use it. 
