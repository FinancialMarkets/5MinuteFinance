...
The goal of this presentation is to show you when to use Monte Carlo, and provide a couple of interactive examples with visualizations.
...
We estimate volatility $\sigma$ using [historical or forward looking measures](https://micfm.shinyapps.io/risk_future_past_mobile/).  However, in a Black-Scholes world the market is complete, and so we can set the drift $\mu$ equal to the risk free rate $r_f$.  
...
Click the following links to see the [code](https://github.com/FinancialMarkets/5MinuteFinance/blob/master/Econometrics/monte_carlo/monte_carlo.Rmd), [authors of this presentation](https://github.com/FinancialMarkets/5MinuteFinance/blame/master/Econometrics/monte_carlo/monte_carlo.Rmd), and [all the collaborators who have contributed to 5MinuteFinance](https://github.com/FinancialMarkets/5MinuteFinance/graphs/contributors).
